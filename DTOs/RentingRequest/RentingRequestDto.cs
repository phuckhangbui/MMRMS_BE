...
namespace DTOs.RentingRequest
{
    ...
    public class NewRentingRequestDto
    {
        ...
        //[Required(ErrorMessage = MessageConstant.RentingRequest.TotalRentPriceRequired)]
        //public double TotalRentPrice { get; set; }

        //[Required(ErrorMessage = MessageConstant.RentingRequest.TotalDepositPriceRequired)]
        ...
        //[Required(ErrorMessage = MessageConstant.RentingRequest.TotalAmountRequired)]
